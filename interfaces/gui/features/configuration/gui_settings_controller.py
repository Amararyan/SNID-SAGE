...
from shared.exceptions.core_exceptions import ConfigurationError
...
class GUISettingsController:
    ...
    def show_settings_dialog(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            from interfaces.gui.components.dialogs.settings_dialog import show_gui_settings_dialog
