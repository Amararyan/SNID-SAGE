...
try:
    from shared.utils.line_detection.interactive_fwhm_analyzer import InteractiveFWHMAnalyzer
    from interfaces.gui.components.analysis.interactive_line_tools import InteractiveLineTools, LivePreviewManager
