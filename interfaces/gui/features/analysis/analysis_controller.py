...
class AnalysisController:
        ...
        try:
            ...
            if needs_reprocessing:
                ...
                try:
                    ...
                    from snid.snid import preprocess_spectrum
            ...
            from snid.snid import run_snid_analysis
        ...
        try:
            ...
            if hasattr(self, '_analysis_result') and self._analysis_result:
                ...
                if result and result.success:
                    ...
                    if hasattr(self, 'game_thread'):
                        try:
                            from snid.games import set_analysis_complete
                    ...
                    if hasattr(self, 'game_thread'):
                        try:
                            from snid.games import notify_analysis_complete, notify_analysis_result
    ...
    def _save_gui_plots(self, result, results_dir):
        ...
        try:
            ...
            from snid.plotting import plot_cluster_subtype_proportions
            ...
            if hasattr(result, 'clustering_results') and result.clustering_results:
                try:
                    from snid.plotting_3d import plot_3d_type_clustering
            ...
            try:
                from snid.plotting import plot_redshift_age
    ...
    def _save_analysis_summary(self, result, results_dir):
        ...
        try:
            import os
            from shared.utils.results_formatter import create_unified_formatter
    ...
    def _show_cluster_selection_dialog(self, result):
        ...
        try:
            from interfaces.gui.components.dialogs.cluster_selection_dialog import show_cluster_selection_dialog
    ...
    def _on_cluster_selected(self, selected_cluster, cluster_index, result):
        ...
        try:
            ...
            if hasattr(result, 'best_matches') and selected_cluster.get('matches'):
                ...
                from shared.utils.math_utils import get_best_metric_value
