...
try:
    from interfaces.gui.components.dialogs.multi_step_emission_dialog import show_multi_step_emission_dialog
...
class EmissionLineOverlayController:
    ...
    def get_status_text(self) -> str:
        ...
        try:
            from interfaces.gui.features.analysis.wind_velocity_controller import WindVelocityController
