...
class SpectrumPreprocessor:
    ...
    def apply_savgol_filter(self, filter_type: str = "fixed", value: float = 11.0, polyorder: int = 3) -> bool:
        ...
        try:
            if filter_type == "fixed" and value >= 3:
                ...
                from snid.preprocessing import savgol_filter_fixed
                ...
                from snid.preprocessing import savgol_filter_wavelength
    ...
    def apply_continuum_fitting(self, method: str = "spline", **kwargs) -> bool:
        ...
        try:
            if method == "gaussian":
                ...
                if sigma is None:
                    from snid.preprocessing import calculate_auto_gaussian_sigma
    ...
    def open_interactive_continuum_editor(self, parent_dialog=None):
        ...
        from interfaces.gui.components.dialogs.continuum_editor_dialog import InteractiveContinuumEditor
            ...
            for i in range(continuum_step_index):
                ...
                if step['type'] == 'savgol_filter':
                    ...
                    if step['clip_type'] == "aband":
                        ...
                        from snid.preprocessing import apply_wavelength_mask
                    ...
                    from snid.preprocessing import log_rebin
