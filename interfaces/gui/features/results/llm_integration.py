...
class LLMIntegration:
    ...
    def _check_openrouter_availability(self):
        ...
        try:
            from interfaces.llm.openrouter.openrouter_llm import get_openrouter_config
    ...
    def _generate_openrouter_summary(self, formatted_results, user_metadata, *, max_tokens: int = 3000, temperature: float = 0.7):
        ...
        try:
            from interfaces.llm.openrouter.openrouter_summary import EnhancedOpenRouterSummary
    ...
    def chat_with_llm(self, message, context="", user_metadata=None, max_tokens=1500):
        ...
        try:
            from interfaces.llm.openrouter.openrouter_llm import call_openrouter_api
    ...
    def configure_openrouter(self):
        ...
        try:
            from interfaces.llm.openrouter.openrouter_llm import configure_openrouter_dialog
    ...
    def _format_emission_lines_for_llm(self):
        ...
        try:
            ...
            try:
                from shared.utils.line_detection.line_detection_utils import detect_and_fit_lines
