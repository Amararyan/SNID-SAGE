...
from interfaces.gui.features.preprocessing.preview_calculator import PreviewCalculator
from interfaces.gui.components.plots.preview_plot_manager import PreviewPlotManager
from interfaces.gui.components.widgets.interactive_continuum_widget import InteractiveContinuumWidget
...
from snid.snid import NW, MINW, MAXW
from snid.preprocessing import (
        ...
        try:
            ...
            if self.preview_calc:
                ...
                if hasattr(self.preprocessor, 'gui') and self.preprocessor.gui:
                    ...
                    from snid.snid import init_wavelength_grid, get_grid_params
                    # log_rebin is no longer needed here – spectrum has been rebinned in Step 3
                    from snid.preprocessing import fit_continuum, clip_aband, clip_sky_lines
                    ...
                    # Use the EXACT same method as standard SNID preprocessing (from snid.py line ~260)
