...
from interfaces.gui.components.dialogs.configuration_dialog import ModernSNIDOptionsDialog
...
def show_snid_analysis_dialog(parent, gui_instance) -> Optional[str]:
    ...
    try:
        from interfaces.gui.utils.unified_theme_manager import get_unified_theme_manager
