...
try:
    from shared.constants.physical import GALAXY_LINES, SPEED_OF_LIGHT_KMS
except ImportError:
...
"""
    ...
    def _accept(self):
        ...
        from interfaces.gui.components.dialogs.redshift_mode_dialog import show_redshift_mode_dialog
