...
def _import_preprocessing():
    ...
    if not _preprocessing_imported:
        try:
            from interfaces.gui.preprocessing_gui import SpectrumPreprocessor, PreprocessingDialog
...
def _import_optional_features():
    ...
    try:
        from shared.utils.line_detection.spectrum_utils import plot_spectrum, apply_savgol_filter
    ...
    try:
        from interfaces.llm.local.gpu_llama import LLAMA_AVAILABLE
