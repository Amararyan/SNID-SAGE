...
from snid.snid import run_snid as python_snid, preprocess_spectrum, run_snid_analysis

# Import games for entertainment during analysis
try:
    from snid.games import show_game_menu, run_game_in_thread
...
from interfaces.gui.utils.unified_font_manager import get_font_manager, FontCategory, apply_font_to_widget
from interfaces.gui.utils.no_title_plot_manager import get_plot_manager, apply_no_title_styling
from interfaces.gui.utils.universal_window_manager import get_window_manager, DialogSize

# Import unified theme manager with workflow support
from interfaces.gui.utils.unified_theme_manager import UnifiedThemeManager

# Import new components
from interfaces.gui.components.plots import SpectrumPlotter, SummaryPlotter, InteractiveTools
from interfaces.gui.components.dialogs import MaskManagerDialog, AISummaryDialog, SNIDAnalysisDialog
from interfaces.gui.components.analysis import AnalysisPlotter

# Import new feature controllers
from interfaces.gui.features.preprocessing.preprocessing_controller import PreprocessingController
from interfaces.gui.features.analysis.analysis_controller import AnalysisController
from interfaces.gui.features.analysis.line_detection import LineDetectionController
from interfaces.gui.features.analysis.emission_line_overlay_controller import EmissionLineOverlayController
from interfaces.gui.features.results.llm_integration import LLMIntegration
from interfaces.gui.features.results.results_manager import ResultsManager

# Import new controllers
from interfaces.gui.controllers.app_controller import AppController
from interfaces.gui.controllers.file_controller import FileController
from interfaces.gui.controllers.plot_controller import PlotController
from interfaces.gui.controllers.view_controller import ViewController
from interfaces.gui.controllers.dialog_controller import DialogController

# Import utilities
from interfaces.gui.utils.gui_helpers import GUIHelpers
from interfaces.gui.utils.layout_utils import LayoutUtils
from interfaces.gui.utils.state_manager import StateManager
from interfaces.gui.utils.logo_manager import LogoManager
from interfaces.gui.utils.spectrum_reset_manager import SpectrumResetManager
from interfaces.gui.utils.import_manager import (_import_matplotlib, _import_preprocessing, _import_pil,
                                    _import_astropy, _import_scipy, _import_snid_dependencies)
from interfaces.gui.utils.startup_manager import (StartupManager, setup_dpi_awareness,
...
from interfaces.gui.utils.event_handlers import EventHandlers
from interfaces.gui.utils.window_event_handlers import WindowEventHandlers

# Add plot theming utilities
from shared.utils.plotting.plot_theming import (
...
class ModernSNIDSageGUI:
    ...
    def __init__(self, master):
        ...
        try:
            from shared.utils.plotting import setup_plot_theme
    ...
    def init_remaining_components(self):
        ...
        try:
            ...
            try:
                from interfaces.gui.components.plots.summary_plotter import SummaryPlotter
            ...
            try:
                from interfaces.gui.components.plots.spectrum_plotter import SpectrumPlotter
            ...
            try:
                from interfaces.gui.features.analysis.games_integration import GamesIntegration
            ...
            try:
                ...
                # from interfaces.gui.utils.plot_navigator import PlotNavigator
    ...
    def init_plot_components(self):
        ...
        try:
            ...
            from interfaces.gui.components.analysis.analysis_plotter import AnalysisPlotter
            ...
            from interfaces.gui.components.plots.interactive_tools import InteractiveTools
    ...
    def open_preprocessing_selection(self):
        ...
        try:
            from interfaces.gui.components.dialogs.preprocessing_selection_dialog import PreprocessingSelectionDialog
    ...
    def _show_unified_ai_dialog(self):
        ...
        try:
            from interfaces.gui.components.dialogs.enhanced_ai_assistant_dialog import EnhancedAIAssistantDialog
...
def main(verbosity_args=None):
    ...
    try:
        ...
        from shared.utils.logging import get_logger, VerbosityLevel
