...
from snid.snid import preprocess_spectrum, run_snid_analysis, SNIDResult
from shared.utils.math_utils import calculate_hybrid_weighted_redshift, calculate_rlap_weighted_age
...
class BatchTemplateManager:
    ...
    def _validate_and_fix_templates_dir(self, templates_dir: str) -> str:
        ...
        try:
            from shared.utils.simple_template_finder import find_templates_directory_or_raise
    ...
    def load_templates_once(self) -> bool:
        ...
        try:
            ...
            try:
                from snid.optimization_integration import (
            ...
            if optimization_available:
                ...
                try:
                    ...
                    try:
                        from snid.core.integration import is_optimization_active
            ...
            if not optimization_available or self._templates is None:
                ...
                from snid.io import load_templates
...
def _save_spectrum_outputs(
    ...
    try:
        if args.minimal:
            ...
            from snid.io import write_result
            spectrum_name = Path(spectrum_path).stem
...
def main(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        from shared.utils.logging import configure_logging, VerbosityLevel
