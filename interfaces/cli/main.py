...
from interfaces.cli import identify, template, batch, config
...
def create_parser() -> argparse.ArgumentParser:
    ...
    identify.add_arguments(identify_parser)
    ...
    template.add_arguments(template_parser)
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    try:
        if args.command == "identify":
            return identify.main(args)
        elif args.command == "template":
            return template.main(args)
