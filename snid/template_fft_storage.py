...
class TemplateFFTStorage:
    ...
    def get_storage_stats(self) -> Dict[str, Any]:
        ...
        for sn_type, type_info in self._index.get('by_type', {}).items():
            storage_file = Path(type_info['storage_file'])
            file_stats = {
                'type': sn_type,
    ...
    def _load_all_templates_with_rebinning(self) -> List[TemplateEntry]:
        ...
        from snid.io import read_template  # Import here to avoid circular imports
        from snid.preprocessing import log_rebin, init_wavelength_grid
