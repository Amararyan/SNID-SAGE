...
try:
    from interfaces.gui.utils.no_title_plot_manager import apply_no_title_styling, get_plot_manager
    from interfaces.gui.utils.unified_font_manager import get_font_manager, FontCategory
...
def plot_type_fractions(result: Any, figsize: Tuple[int, int] = (10, 8),
    ...
    is varied. Uses the comprehensive statistics from snid.py including GMM filtering
    ...
    if subtype_counts:
        ...
        for subtype, count in sorted_subtypes:
            ...
            if len(subtype_redshifts[subtype]) > 1:
                from shared.utils.math_utils import calculate_hybrid_weighted_redshift
            ...
            if len(subtype_ages[subtype]) > 1:
                from shared.utils.math_utils import calculate_rlap_weighted_age
