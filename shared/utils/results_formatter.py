...
class UnifiedResultsFormatter:
    ...
    def _create_standardized_summary(self) -> Dict[str, Any]:
        ...
        if winning_cluster and cluster_matches:
            ...
            try:
                from shared.utils.math_utils.weighted_statistics import calculate_rlap_weighted_age
                ages = []
                age_rlaps = []
        ...
        if winning_cluster and cluster_matches:
            ...
            if 'subtype_info' in winning_cluster:
                ...
                try:
                    from snid.cosmological_clustering import choose_subtype_weighted_voting
    ...
    def _format_template_matches(self, matches: List[Dict]) -> List[Dict[str, Any]]:
        ...
        for i, match in enumerate(matches, 1):
            ...
            from shared.utils.math_utils import get_metric_display_values, get_best_metric_value
